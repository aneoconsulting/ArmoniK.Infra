...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_gke_standard"></a> [gke\_standard](#module\_gke\_standard) | terraform-google-modules/kubernetes-engine/google | 27.0.0 |
...
| <a name="input_default_max_pods_per_node"></a> [default\_max\_pods\_per\_node](#input\_default\_max\_pods\_per\_node) | The maximum number of pods to schedule per node. Note: For GKE versions earlier than 1.23.5-gke.1300, the limit is 110 Pods. | `number` | `256` | no |
