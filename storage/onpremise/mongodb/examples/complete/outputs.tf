output "host" {
  ...
  value       = module.complete_mongodb_instance.host
}

output "port" {
  description = "Port of MongoDB server"
  value       = module.complete_mongodb_instance.port
}

output "url" {
  description = "URL of MongoDB server"
  value       = module.complete_mongodb_instance.url
}

output "number_of_replicas" {
  description = "Number of replicas of MongoDB"
  value       = module.complete_mongodb_instance.number_of_replicas
}

# SENSITIVE OUTPUTS
output "user_credentials" {
  description = "User credentials of MongoDB"
  value       = module.complete_mongodb_instance.user_credentials
  sensitive   = true
}

output "endpoints" {
  description = "Endpoints of MongoDB"
  value       = module.complete_mongodb_instance.endpoints
  sensitive   = true
}

output "unused_variables" {
  description = "Map of variables that are not used yet but might be in the future"
  value       = module.complete_mongodb_instance.unused_variables
}
