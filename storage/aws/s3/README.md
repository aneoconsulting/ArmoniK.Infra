...
| <a name="input_service_account_role_name"></a> [service\_account\_role\_name](#input\_service\_account\_role\_name) | Name of the IAM role to give the SQS permissions to | `optional(string)` | n/a | yes |
