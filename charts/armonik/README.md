...
| gcs.credentialsFilePath | string | `""` |  |
| gcs.emulatorEndpoint | string | `""` |  |
| gcs.enabled | bool | `false` |  |
| gcs.projectId | string | `""` |  |
