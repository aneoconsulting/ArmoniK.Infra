output "endpoint_urls" {
  ...
  value = var.ingress != null ? {
    ...
    admin_0_8_url     = length(kubernetes_service.admin_0_8_gui) > 0 ? (local.ingress_http_url != "" ? "${local.ingress_http_url}/0_8-admin" : local.admin_0_8_url) : null
    admin_0_9_url     = length(kubernetes_service.admin_0_9_gui) > 0 ? (local.ingress_http_url != "" ? "${local.ingress_http_url}/0_9-admin" : local.admin_0_9_url) : null
    } : {
