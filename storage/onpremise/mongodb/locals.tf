locals {
  node_selector_keys   = length(keys(var.mongodb.node_selector)) == 0 ? keys(var.mongodb.node_selector) : []
  node_selector_values = length(values(var.mongodb.node_selector)) == 0 ? values(var.mongodb.node_selector) : []
