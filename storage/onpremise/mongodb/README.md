...
|------|-------------|------|---------|:--------:|
| <a name="input_helm_release_name"></a> [helm\_release\_name](#input\_helm\_release\_name) | Name of the helm chart release, must be shorter than 54 characters | `string` | `"mongodb-arm"` | no |
| <a name="input_kube_config_path"></a> [kube\_config\_path](#input\_kube\_config\_path) | Local file path of the kubernetes configuration | `string` | `"~/.kube/config"` | no |
