...
| <a name="input_mongodb_modules"></a> [mongodb\_modules](#input\_mongodb\_modules) | MongoDB modules to use when building the exporter (assumes only one is actually active) | `list(any)` | n/a | yes |
