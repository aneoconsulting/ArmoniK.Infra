...
| <a name="input_fluent_bit_output"></a> [fluent\_bit\_output](#input\_fluent\_bit\_output) | the fluent-bit module output | `any` | `{}` | no |
| <a name="input_grafana_output"></a> [grafana\_output](#input\_grafana\_output) | the grafana module output | `any` | `{}` | no |
...
| <a name="input_shared_storage_settings"></a> [shared\_storage\_settings](#input\_shared\_storage\_settings) | the shared-storage configuration information | `any` | `{}` | no |
