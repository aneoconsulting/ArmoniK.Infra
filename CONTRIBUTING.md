...
Terraform documentation is auto-generated by terraform-docs during ReadTheDocs build
Manual content in README.md files should be kept, but terraform-generated sections
(between `<!-- BEGIN_TF_DOCS -->` and `<!-- END_TF_DOCS -->`) are not committed
Run ./generate-tf-docs.sh locally to preview generated docs
